...
function installToMediaWikiRoot {
	...
	if [ "$SFS" != "" ]
	then
		composer require 'mediawiki/smw-parent='$SMT --prefer-source --update-with-dependencies
	else
		composer init --stability dev
		composer require "mediawiki/smw-parent:dev-master" --prefer-source --dev --update-with-dependencies
...
function updateConfiguration {
	...
	echo 'wfLoadExtension( "SMWParent" );' >> LocalSettings.php
